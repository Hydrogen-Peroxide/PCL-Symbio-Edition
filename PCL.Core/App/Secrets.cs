...
public static class Secrets
{
    ...
    /// </summary>
    public static string MSOAuthClientId { get; } = EnvironmentInterop.GetSecret("MS_CLIENT_ID", readEnvDebugOnly: true).ReplaceNullOrEmpty("d4915fd6-8245-4bd4-a150-396834b705b5");
