...
public static partial class Config
{
    ...
    [ConfigGroup("Preference")] partial class PreferenceConfigGroup
    {
        ...
        [ConfigGroup("Localization", ConfigSource.Local)] partial class LocalizationConfigGroup
        {
            ...
            /// UI 语言。zh-CN 表示简体中文。
            /// </summary>
            [ConfigItem<string>("UiLanguage", "zh-CN")] public partial string Language { get; set; }
    ...
    [ConfigGroup("Launch")] partial class LaunchConfigGroup
    {
        ...
        /// 自定义左下角版本信息。
        /// </summary>
        [ConfigItem<string>("LaunchArgumentInfo", "PCL SO", ConfigSource.Local)] public partial string TypeInfo { get; set; }
